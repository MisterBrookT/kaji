...
Current module identifiers include Quota, Work, System, Goals, AI News, and Mail Brief. Quota is the small default experience. Optional modules are enabled through preferences and appear only when selected.
