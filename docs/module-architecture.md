...
Current module identifiers include Quota, Work, and Goals. Quota is the small default experience. Optional modules are enabled through preferences and appear only when selected.
